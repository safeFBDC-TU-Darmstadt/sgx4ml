...
# find_path(DNNL_INCLUDE_DIR dnnl.h "${SGX_INCLUDE_DIR}" NO_DEFAULT_PATH)
# if(DNNL_INCLUDE_DIR)
#     message(STATUS "Found Intel SGX DNNL: ${DNNL_INCLUDE_DIR}")
# endif()
    ...
    function(add_trusted_library target)
        ...
        if(${SGX_USE_SGXSSL})
            ...
            target_link_libraries(${target} "${SGX_COMMON_CFLAGS} \
                ...
                -Wl,--start-group -lsgx_tsgxssl -lsgx_tsgxssl_crypto -lsgx_tstdc -lsgx_pthread -lsgx_tcxx -lsgx_tkey_exchange -lsgx_tcrypto -lsgx_dnnl -lsgx_omp -l${SGX_TSVC_LIB} -Wl,--end-group \
            ...
            target_link_libraries(${target} "${SGX_COMMON_CFLAGS} \
                ...
                -Wl,--start-group -lsgx_tstdc -lsgx_tcxx -lsgx_tkey_exchange -lsgx_tcrypto -lsgx_pthread -lsgx_omp -lsgx_dnnl -l${SGX_TSVC_LIB} -Wl,--end-group \
                -Wl,-Bstatic -Wl,-Bsymbolic -Wl,--no-undefined \
                -Wl,-pie,-eenclave_entry -Wl,--export-dynamic \
                ${LDSCRIPT_FLAG} \
                -Wl,--defsym,__ImageBase=0")
    ...
    function(add_enclave_library target)
        ...
        if(${SGX_USE_SGXSSL})
            ...
            target_link_libraries(${target} "${SGX_COMMON_CFLAGS} \
                ...
                -Wl,--start-group ${TLIB_LIST} -lsgx_tsgxssl -lsgx_tsgxssl_crypto -lsgx_tstdc -lsgx_pthread -lsgx_tcxx -lsgx_tkey_exchange -lsgx_tcrypto -lsgx_omp -lsgx_dnnl -l${SGX_TSVC_LIB} -Wl,--end-group \
                -Wl,-Bstatic -Wl,-Bsymbolic -Wl,--no-undefined \
                -Wl,-pie,-eenclave_entry -Wl,--export-dynamic \
                ${LDSCRIPT_FLAG} \
            ...
            target_link_libraries(${target} "${SGX_COMMON_CFLAGS} \
                -Wl,--no-undefined -nostdlib -nodefaultlibs -nostartfiles -L${SGX_LIBRARY_PATH} \
                -Wl,--whole-archive -l${SGX_TRTS_LIB} -Wl,--no-whole-archive \
                -Wl,--start-group ${TLIB_LIST} -lsgx_tstdc -lsgx_tcxx -lsgx_tkey_exchange -lsgx_tcrypto -lsgx_pthread -lsgx_omp -lsgx_dnnl -l${SGX_TSVC_LIB} -Wl,--end-group \
                -Wl,-Bstatic -Wl,-Bsymbolic -Wl,--no-undefined \
                -Wl,-pie,-eenclave_entry -Wl,--export-dynamic \
                ${LDSCRIPT_FLAG} \
                -Wl,--defsym,__ImageBase=0 -Wl,--gc-sections")
